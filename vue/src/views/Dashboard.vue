	...
	<PageComponent title="Dashboard">
		...
		>
			...
			>
				...
				<img :src="data.latest_survey.image_url" class="w-[240px] mx-auto" />
				...
				<div class="flex justify-between">
					<router-link
						...
						class="flex py-2 px-4 border border-transparent text-sm rounded-md text-indigo-500 hover:bg-indigo-700 hover:text-white transition-colors focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 items-center justify-between"
					>
						<svg
			...
			<a href="#" v-for="answer of data.latest_answers" :key="answer.id" class="block p-2 hover:bg-gray-100/90">
