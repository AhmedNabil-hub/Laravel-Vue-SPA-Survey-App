	...
	<div class="flex items-center justify-between">
		...
		<div class="flex items-center">
			<button
				type="button"
				@click="addQuestion()"
				class="flex items-center text-xs py-1 px-3 mr-2 rounded-md text-white bg-gray-600 hover:bg-gray-700"
			>
				<svg
			...
			<button
				...
				class="flex items-center text-xs py-1 px-3 mr-2 rounded-md text-white bg-red-600 hover:bg-red-700"
			>
				<svg
					xmlns="http://www.w3.org/2000/svg"
					fill="none"
